...
public class NavigationBarView extends LinearLayout {
    ...
    //KOSP-RefreshScreen
    public View getRefreshScreenButton() {
        return mCurrentView.findViewById(R.id.eink_refresh);
    } 
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mDelegateHelper.setInitialTouchRegion(getHomeButton(), getBackButton(), getRecentsButton(), getRefreshScreenButton());
    }
