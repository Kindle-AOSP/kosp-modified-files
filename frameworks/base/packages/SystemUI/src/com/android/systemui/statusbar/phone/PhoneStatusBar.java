...
//KOSP-RefreshScreen
    View.OnTouchListener mRefreshScreenListener = new View.OnTouchListener() {
        public boolean onTouch(View v, MotionEvent event) {
            switch(event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    Log.d(TAG, "###press1");
    ...
    private void prepareNavigationBarView() {
        ...
        mNavigationBarView.getRefreshScreenButton().setOnTouchListener(mRefreshScreenListener);
        updateSearchPanel();
    }
